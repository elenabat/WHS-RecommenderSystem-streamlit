...
data_country2 = data2.groupby(['country', 'continent', 'region_en', 'name_en', 'planet_earth', 'short_description_en'])['index'].count().reset_index()
...
#Treemap
fig = px.treemap(data_country2, path=['planet_earth', 'region_en', 'country', 'name_en', 'short_description_en'], values='count',
